...
function calcPrint(def, gen, cols = 3, section = null, { pages = 2 } = {}) {
  // 文体は学年で使い分け: 小4〜6 は「求めよ」体、小1〜3 は「しましょう」体。
  if (section === null) section = def.grade >= 4 ? "次の 計算を せよ。" : "つぎの けいさんを しましょう";
...
function buildG4() {
  ...
  add({ grade: G, subject: "算数", id: "g4-01", unitNo: 1, name: "算数4年① 大きい数", title: "大きい数", subtitle: "億・兆", goal: "億や 兆の 大きい数を よめるように なろう！", desc: "億・兆。整数の仕組み、大きな数のかけ算・わり算。",
    body: iplusBody([
      { q: "1000万を 10こ あつめた数は いくつか。", a: "1億" },
      { q: "1億を 1000こ あつめた数は いくつか。", a: "1000億" },
      { q: "$50000\\times100$ を 計算せよ。", a: "5000000" },
      { q: "$8000000\\div1000$ を 計算せよ。", a: "8000" },
      { q: "1兆は 1億の 何倍か。", a: "10000 倍" },
      { q: "3億5000万を 数字で 書け。", a: "350000000" },
      { q: "1000万を 100こ あつめた数は いくつか。", a: "10億" },
      { q: "7億2000万を 数字で 書け。", a: "720000000" },
      { q: "$40000\\times1000$ を 計算せよ。", a: "40000000" },
      { q: "$3000000\\div100$ を 計算せよ。", a: "30000" },
    ], { section: "大きい数に ついて 答えよ" }) });
  ...
  add({ grade: G, subject: "算数", id: "g4-02", unitNo: 2, name: "算数4年② 折れ線グラフ", title: "折れ線グラフ", subtitle: "へんかを よみとる", goal: "折れ線グラフから かわりかたを よみとろう！", desc: "折れ線グラフの読み方・かき方。",
    body: iplusBody([
      { q: "いちばん 気温が 高いのは 何時か。", a: "12時" },
      { q: "いちばん 気温が ひくいのは 何時か。", a: "9時" },
      { q: "10時の 気温は 何℃か。", a: "17 ℃" },
      { q: "9時から 12時までに 気温は 何℃ 上がったか。", a: "8 ℃" },
      { q: "11時から 12時までに 気温は 何℃ 上がったか。", a: "2 ℃" },
      { q: "気温が 下がったのは 何時から 何時の あいだか。", a: "12時〜13時" },
    ], { section: "折れ線グラフを よんで 答えよ", intro: "{\\large ある日の 気温(℃)}\\par\\vspace{1mm}\\begin{kpgraph}{6}{5}\\kpgx{1}{9時}\\kpgx{2}{10時}\\kpgx{3}{11時}\\kpgx{4}{12時}\\kpgx{5}{13時}\\kpgy{1}{5}\\kpgy{2}{10}\\kpgy{3}{15}\\kpgy{4}{20}\\kpgy{5}{25}\\kpgline{(1,2.8) (2,3.4) (3,4) (4,4.4) (5,4.2)}\\end{kpgraph}" }) });
  ...
  add({ grade: G, subject: "算数", id: "g4-05", unitNo: 5, name: "算数4年⑤ がい数 (四捨五入)", title: "がい数", subtitle: "四捨五入", goal: "四捨五入して、およその 数で あらわそう！", desc: "概数、四捨五入、概算。",
    body: iplusBody([
      { q: "2834 を 四捨五入して 百のくらいまでの がい数に せよ。", a: "2800" },
      { q: "4567 を 四捨五入して 千のくらいまでの がい数に せよ。", a: "5000" },
      { q: "31250 を 四捨五入して 一万のくらいまでの がい数に せよ。", a: "30000" },
      { q: "785 を 四捨五入して 十のくらいまでの がい数に せよ。", a: "790" },
      { q: "6480 を 四捨五入して 百のくらいまでの がい数に せよ。", a: "6500" },
      { q: "7321 を 四捨五入して 百のくらいまでの がい数に せよ。", a: "7300" },
      { q: "850 を 四捨五入して 百のくらいまでの がい数に せよ。", a: "900" },
      { q: "12345 を 四捨五入して 千のくらいまでの がい数に せよ。", a: "12000" },
      { q: "28500 を 四捨五入して 千のくらいまでの がい数に せよ。", a: "29000" },
      { q: "962 を 四捨五入して 十のくらいまでの がい数に せよ。", a: "960" },
    ], { section: "四捨五入して がい数に せよ" }) });
  ...
  add({ grade: G, subject: "算数", id: "g4-06", unitNo: 6, name: "算数4年⑥ 角", title: "角の 大きさ", subtitle: "角度", goal: "角の 大きさ(角度)を かんがえよう！", desc: "回転角、角の単位(度)。1直角=90度。",
    body: iplusBody([
      { q: "1直角は 何度か。", a: "90 度" },
      { q: "2直角(まっすぐ)は 何度か。", a: "180 度" },
      { q: "1回転は 何度か。", a: "360 度" },
      { q: "三角じょうぎの いちばん 大きい角は 何度か。", a: "90 度" },
      { q: "3直角は 何度か。", a: "270 度" },
      { q: "直角の 半分の 角は 何度か。", a: "45 度" },
      { q: "60度と 30度を あわせると 何度か。", a: "90 度" },
      { q: "120度は 1直角より 何度 大きいか。", a: "30 度" },
      { q: "180度から 50度を ひくと 何度か。", a: "130 度" },
      { q: "1回転の 半分は 何度か。", a: "180 度" },
    ], { section: "角の 大きさ(角度)を 答えよ" }) });
  ...
  add({ grade: G, subject: "算数", id: "g4-07", unitNo: 7, name: "算数4年⑦ 垂直・平行と 四角形", title: "垂直・平行と 四角形", subtitle: "いろいろな 四角形", goal: "垂直・平行と、いろいろな 四角形を しらべよう！", desc: "垂直・平行の意味、台形・平行四辺形・ひし形。",
    body: iplusBody([
      { q: "むかいあった 2くみの 辺が 平行な 四角形を 何と いうか。", a: "平行四辺形" },
      { q: "4つの 辺の 長さが みんな 同じ 四角形を 何と いうか。", a: "ひし形" },
      { q: "1くみの 辺だけが 平行な 四角形を 何と いうか。", a: "台形" },
      { q: "4つの 角が みんな 直角の 四角形を 何と いうか。", a: "長方形" },
      { q: "4つの 辺が 同じで 4つの 角が 直角の 四角形を 何と いうか。", a: "正方形" },
      { q: "平行四辺形の むかいあう 辺の 長さは どうなって いるか。", a: "等しい" },
      { q: "平行四辺形の むかいあう 角の 大きさは どうなって いるか。", a: "等しい" },
      { q: "台形で 平行な 辺は 何くみ あるか。", a: "1 くみ" },
    ], { section: "四角形の なまえを 答えよ" }) });
  ...
  add({ grade: G, subject: "算数", id: "g4-08", unitNo: 8, name: "算数4年⑧ 小数", title: "小数の しくみ", subtitle: "小数第二・三位", goal: "0.01 や 0.001 の くらいの 小数を かんがえよう！", desc: "小数第二位・三位、小数の仕組み。",
    body: iplusBody([
      { q: "0.01 を 7こ あつめた数は いくつか。", a: "0.07" },
      { q: "0.1 を 23こ あつめた数は いくつか。", a: "2.3" },
      { q: "$3.14\\times10$ を 計算せよ。", a: "31.4" },
      { q: "$5.6\\div10$ を 計算せよ。", a: "0.56" },
      { q: "0.001 を 5こ あつめた数は いくつか。", a: "0.005" },
      { q: "0.01 を 30こ あつめた数は いくつか。", a: "0.3" },
      { q: "2.5 は 0.1 を 何こ あつめた数か。", a: "25 こ" },
      { q: "$4.07\\times100$ を 計算せよ。", a: "407" },
      { q: "$0.8\\div100$ を 計算せよ。", a: "0.008" },
      { q: "0.1 を 100こ あつめた数は いくつか。", a: "10" },
    ], { section: "小数の しくみに ついて 答えよ" }) });
  ...
  add({ grade: G, subject: "算数", id: "g4-12", unitNo: 12, name: "算数4年⑫ 式と計算", title: "式と 計算", subtitle: "( )・四則の じゅんじょ", goal: "( )や かけ算・わり算を 先に 計算しよう！", desc: "四則の混じった式、計算の順序、( )。",
    body: calcBody([{ expr: "3+4\\times2=", ans: 11 }, { expr: "(3+4)\\times2=", ans: 14 }, { expr: "20-12\\div4=", ans: 17 }, { expr: "(20-12)\\div4=", ans: 2 }, { expr: "8\\times(5-2)=", ans: 24 }, { expr: "6+18\\div3=", ans: 12 }, { expr: "36\\div(4+2)=", ans: 6 }, { expr: "5\\times4-12\\div3=", ans: 16 }, { expr: "(15-7)\\times(2+3)=", ans: 40 }, { expr: "48\\div6+7\\times2=", ans: 22 }], "計算の じゅんじょ(( )・$\\times\\div$ が さき)に 気を つけて 計算せよ") });
  ...
  add({ grade: G, subject: "算数", id: "g4-13", unitNo: 13, name: "算数4年⑬ 面積", title: "面積", subtitle: "長方形・正方形", goal: "長方形・正方形の 面積を もとめよう！", desc: "面積の意味と単位、長方形・正方形の面積公式。",
    body: iplusBody([
      { q: "たて 4cm、よこ 6cm の 長方形の 面積を 求めよ。($4\\times6$)", a: "24 cm$^2$" },
      { q: "1辺 5cm の 正方形の 面積を 求めよ。($5\\times5$)", a: "25 cm$^2$" },
      { q: "たて 8m、よこ 10m の 長方形の 面積を 求めよ。", a: "80 m$^2$" },
      { q: "$1$ m$^2$ は 何 cm$^2$ か。", a: "10000 cm$^2$" },
      { q: "たて 7cm、よこ 9cm の 長方形の 面積を 求めよ。", a: "63 cm$^2$" },
      { q: "1辺 8cm の 正方形の 面積を 求めよ。", a: "64 cm$^2$" },
      { q: "たて 5m、よこ 12m の 長方形の 面積を 求めよ。", a: "60 m$^2$" },
      { q: "1辺 10cm の 正方形の 面積を 求めよ。", a: "100 cm$^2$" },
      { q: "面積 60cm$^2$、たて 6cm の 長方形の よこの 長さは 何 cm か。", a: "10 cm" },
      { q: "1 km$^2$ は 何 m$^2$ か。", a: "1000000 m$^2$" },
    ], { section: "面積を 求めよ" }) });
  ...
  add({ grade: G, subject: "算数", id: "g4-14", unitNo: 14, name: "算数4年⑭ 分数", title: "分数", subtitle: "仮分数・帯分数", goal: "仮分数と 帯分数を なおせるように なろう！", desc: "真分数・仮分数・帯分数、同分母分数の加減。",
    body: iplusBody([
      { q: "$\\frac{7}{3}$ を 帯分数に なおせ。", a: "$2\\frac{1}{3}$" },
      { q: "$1\\frac{2}{5}$ を 仮分数に なおせ。", a: "$\\frac{7}{5}$" },
      { q: "$\\frac{2}{6}$ を かんたんに せよ。", a: "$\\frac{1}{3}$" },
      { q: "$\\frac{4}{5}+\\frac{3}{5}$ を 計算せよ。", a: "$\\frac{7}{5}$" },
      { q: "$\\frac{11}{4}$ を 帯分数に なおせ。", a: "$2\\frac{3}{4}$" },
      { q: "$2\\frac{2}{5}$ を 仮分数に なおせ。", a: "$\\frac{12}{5}$" },
      { q: "$\\frac{9}{6}$ を かんたんに せよ。", a: "$\\frac{3}{2}$" },
      { q: "$\\frac{3}{7}+\\frac{2}{7}$ を 計算せよ。", a: "$\\frac{5}{7}$" },
      { q: "$1-\\frac{2}{5}$ を 計算せよ。", a: "$\\frac{3}{5}$" },
      { q: "$\\frac{4}{3}+\\frac{5}{3}$ を 計算せよ。", a: "3" },
    ], { section: "分数に ついて 答えよ" }) });
  ...
  add({ grade: G, subject: "算数", id: "g4-15", unitNo: 15, name: "算数4年⑮ 直方体と 立方体", title: "直方体と 立方体", subtitle: "面・辺・頂点", goal: "直方体・立方体の 面・辺・頂点を しらべよう！", desc: "直方体・立方体の定義と性質、見取図・展開図。",
    body: iplusBody([
      ...
      { q: "辺は いくつ あるか。", a: "12 つ" },
      { q: "頂点は いくつ あるか。", a: "8 つ" },
      { q: "立方体の 面の 形は 何か。", a: "正方形" },
      { q: "むかいあう 面は 何くみ あるか。", a: "3 くみ" },
      { q: "1つの 頂点に 集まる 辺は 何本か。", a: "3 本" },
      { q: "立方体の 辺の 長さは どうなって いるか。", a: "みんな 同じ" },
    ], { section: "立方体に ついて 答えよ", intro: "\\begin{center}\\begin{tikzpicture}[scale=0.9]\\kpcube{0}{0}\\end{tikzpicture}\\end{center}" }) });
  ...
  add({ grade: G, subject: "算数", id: "g4-16", unitNo: 16, name: "算数4年⑯ ともなって 変わる量", title: "ともなって 変わる量", subtitle: "□と○の かんけい", goal: "2つの 量の かわりかたを 式に あらわそう！", desc: "伴って変わる2つの量、□や○を使った式。",
    body: iplusBody([
      { q: "□と ○の かんけいを 式に あらわすと、○ $=$ □ $\\times$ □ の □に 入る数は いくつか。", a: "4" },
      { q: "□が 7 の とき、○は いくつか。", a: "28" },
      { q: "○が 40 の とき、□は いくつか。", a: "10" },
      { q: "□が 5 の とき、○は いくつか。", a: "20" },
      { q: "○が 24 の とき、□は いくつか。", a: "6" },
      { q: "○は □の 何倍か。", a: "4 倍" },
    ], { section: "ともなって 変わる量に ついて 答えよ", intro: "{\\large 1辺が □cm の 正方形の まわりの 長さを ○cm と すると、\\par □が 1, 2, 3, 4 の とき ○は 4, 8, 12, 16}" }) });
...
function buildG5() {
  ...
  add({ grade: G, subject: "算数", id: "g5-01", unitNo: 1, name: "算数5年① 小数と整数", title: "小数と 整数", subtitle: "10倍・1/10", goal: "小数を 10倍・$\\frac{1}{10}$ したときの しくみを かんがえよう！", desc: "十進位取り記数法、小数を10倍・1/10した数。",
    body: iplusBody([
      { q: "$2.74\\times10$ を 計算せよ。", a: "27.4" },
      { q: "$2.74\\times100$ を 計算せよ。", a: "274" },
      { q: "$36\\div10$ を 計算せよ。", a: "3.6" },
      { q: "$5\\div100$ を 計算せよ。", a: "0.05" },
      { q: "$0.38\\times10$ を 計算せよ。", a: "3.8" },
      { q: "$0.38\\times100$ を 計算せよ。", a: "38" },
      { q: "$4.5\\times1000$ を 計算せよ。", a: "4500" },
      { q: "$7\\div10$ を 計算せよ。", a: "0.7" },
      { q: "$250\\div100$ を 計算せよ。", a: "2.5" },
      { q: "$0.06\\times10$ を 計算せよ。", a: "0.6" },
    ], { section: "10倍・$\\frac{1}{10}$ の しくみで 計算せよ" }) });
  ...
  add({ grade: G, subject: "算数", id: "g5-02", unitNo: 2, name: "算数5年② 合同な図形", title: "合同な 図形", subtitle: "対応する 辺・角", goal: "ぴったり 重なる 図形の 対応を しらべよう！", desc: "合同の意味、対応する頂点・辺・角。",
    body: iplusBody([
      { q: "辺DE の 長さは 何 cm か。", a: "5 cm" },
      { q: "角E の 大きさは 何度か。", a: "40 度" },
      { q: "合同な 図形で ぴったり 重なる 頂点を 何と いうか。", a: "対応する 頂点" },
      { q: "合同な 図形の 対応する 辺の 長さは どうなって いるか。", a: "等しい" },
      { q: "合同な 図形の 対応する 角の 大きさは どうなって いるか。", a: "等しい" },
      { q: "辺AB に 対応する 辺は どれか。", a: "辺DE" },
    ], { section: "合同な 図形に ついて 答えよ", intro: "{\\large 三角形ABC と 三角形DEF が 合同で、AB$=$5cm、角B$=$40度です。}" }) });
  ...
  add({ grade: G, subject: "算数", id: "g5-03", unitNo: 3, name: "算数5年③ 比例", title: "比例", subtitle: "ともなって 変わる量", goal: "一方が 2倍、3倍に なると もう一方も…の かんけいを しらべよう！", desc: "比例の関係、表に表す。",
    body: iplusBody([
      { q: "○は □に 比例しています。○ $=$ □ $\\times$ □ の さいしょの □に 入る きまった数は いくつか。", a: "80" },
      { q: "長さが 6m の とき、代金は 何円か。", a: "480 円" },
      { q: "代金が 800円の とき、長さは 何 m か。", a: "10 m" },
      { q: "長さが 2倍に なると、代金は 何倍に なるか。", a: "2 倍" },
      { q: "長さが 5m の とき、代金は 何円か。", a: "400 円" },
      { q: "代金が 640円の とき、長さは 何 m か。", a: "8 m" },
    ], { section: "比例の かんけいに ついて 答えよ", intro: "{\\large 1mの ねだんが 80円の リボン\\quad 長さ □m … 1, 2, 3, 4 ／ 代金 ○円 … 80, 160, 240, 320}" }) });
  ...
  add({ grade: G, subject: "算数", id: "g5-04", unitNo: 4, name: "算数5年④ 平均", title: "平均", subtitle: "ならすと いくつ", goal: "いくつかの 数を ならした 平均を もとめよう！", desc: "平均の意味と求め方。",
    body: iplusBody([
      { q: "3, 5, 4 の 平均を 求めよ。($(3+5+4)\\div3$)", a: "4" },
      { q: "10, 8, 6, 12 の 平均を 求めよ。", a: "9" },
      { q: "テスト 80点, 90点, 70点 の 平均を 求めよ。", a: "80 点" },
      { q: "6, 4, 8, 2 の 平均を 求めよ。", a: "5" },
      { q: "12, 15, 9 の 平均を 求めよ。", a: "12" },
      { q: "5回の テストの 合計が 400点の とき、平均は 何点か。", a: "80 点" },
      { q: "平均が 6 で 3こ あるとき、合計は いくつか。", a: "18" },
      { q: "20, 30, 40, 50 の 平均を 求めよ。", a: "35" },
      { q: "1, 2, 3, 4, 5 の 平均を 求めよ。", a: "3" },
    ], { section: "平均を 求めよ" }) });
  ...
  add({ grade: G, subject: "算数", id: "g5-05", unitNo: 5, name: "算数5年⑤ 単位量あたりの 大きさ", title: "単位量あたりの 大きさ", subtitle: "こみぐあい", goal: "1あたりの 大きさで くらべよう！", desc: "単位量あたりの大きさ、混み具合・人口密度。",
    body: iplusBody([
      { q: "8m$^2$ に 24人 いる へやの 1m$^2$ あたりの 人数を 求めよ。($24\\div8$)", a: "3 人" },
      { q: "5L で 300km 走る車の 1L あたりの きょりを 求めよ。($300\\div5$)", a: "60 km" },
      { q: "A室は 6畳に 9人、B室は 8畳に 10人 います。こんでいるのは どちらか。", a: "A室" },
      { q: "12m$^2$ に 36人 いる へやの 1m$^2$ あたりの 人数を 求めよ。", a: "3 人" },
      { q: "4L で 200km 走る車の 1L あたりの きょりを 求めよ。", a: "50 km" },
      { q: "1km$^2$ あたり 500人 で 5km$^2$ の 町の 人口は 何人か。", a: "2500 人" },
      { q: "300円で 6こ 買える えんぴつ 1本の ねだんは 何円か。", a: "50 円" },
      { q: "5kg で 2000円の 肉は、1kg あたり 何円か。", a: "400 円" },
      { q: "A町は 6000人で 3km$^2$、B町は 9000人で 4km$^2$。人口が こんでいるのは どちらか。", a: "B町" },
    ], { section: "単位量あたりの 大きさで 比べよ" }) });
  ...
  add({ grade: G, subject: "算数", id: "g5-08", unitNo: 8, name: "算数5年⑧ 速さ", title: "速さ", subtitle: "速さ・道のり・時間", goal: "速さ $=$ 道のり $÷$ 時間。 速さの もとめ方を おぼえよう！", desc: "速さの意味と求め方(時速・分速・秒速)。",
    body: iplusBody([
      { q: "120km を 3時間で 走る車の 時速を 求めよ。($120\\div3$)", a: "時速 40 km" },
      { q: "時速 60km で 2時間 走ると、道のりは 何 km か。($60\\times2$)", a: "120 km" },
      { q: "240km を 時速 80km で 走ると、かかる時間は 何時間か。($240\\div80$)", a: "3 時間" },
      { q: "100m を 20秒で 走る人の 秒速を 求めよ。", a: "秒速 5 m" },
      { q: "分速 80m で 5分 歩くと、道のりは 何 m か。", a: "400 m" },
      { q: "360km を 時速 90km で 走ると、かかる時間は 何時間か。", a: "4 時間" },
      { q: "150km を 2時間で 走る車の 時速を 求めよ。", a: "時速 75 km" },
      { q: "時速 60km は、分速 何 m か。", a: "分速 1000 m" },
      { q: "2km の 道を 分速 250m で 歩くと、何分 かかるか。", a: "8 分" },
    ], { section: "速さ・道のり・時間を 求めよ" }) });
  ...
  add({ grade: G, subject: "算数", id: "g5-09", unitNo: 9, name: "算数5年⑨ 図形の 角", title: "図形の 角", subtitle: "内角の 和", goal: "三角形や 四角形の 角の 大きさの 和を しらべよう！", desc: "三角形・多角形の内角の和。",
    body: iplusBody([
      { q: "三角形の 3つの 角の 大きさの 和は 何度か。", a: "180 度" },
      { q: "四角形の 4つの 角の 大きさの 和は 何度か。", a: "360 度" },
      { q: "2つの 角が 50度、60度 の 三角形の のこりの 角は 何度か。", a: "70 度" },
      { q: "五角形の 角の 大きさの 和は 何度か。", a: "540 度" },
      { q: "六角形の 角の 大きさの 和は 何度か。", a: "720 度" },
      { q: "七角形の 角の 大きさの 和は 何度か。", a: "900 度" },
      { q: "2つの 角が 90度、40度 の 三角形の のこりの 角は 何度か。", a: "50 度" },
      { q: "正三角形の 1つの 角は 何度か。", a: "60 度" },
      { q: "三角形で 1つの 角が 直角、もう1つが 30度の とき、のこりの 角は 何度か。", a: "60 度" },
      { q: "正方形の 1つの 角は 何度か。", a: "90 度" },
    ], { section: "図形の 角に ついて 答えよ" }) });
  ...
  add({ grade: G, subject: "算数", id: "g5-10", unitNo: 10, name: "算数5年⑩ 倍数と 約数", title: "倍数と 約数", subtitle: "公倍数・公約数", goal: "最小公倍数・最大公約数を もとめよう！", desc: "倍数・公倍数・最小公倍数、約数・公約数・最大公約数。",
    body: iplusBody([
      { q: "6と 8の 最小公倍数を 求めよ。", a: "24" },
      { q: "12と 18の 最大公約数を 求めよ。", a: "6" },
      { q: "4と 6の 最小公倍数を 求めよ。", a: "12" },
      { q: "16の 約数を すべて 書け。(1, 2, 4, 8, …)", a: "1, 2, 4, 8, 16" },
      { q: "3と 5の 最小公倍数を 求めよ。", a: "15" },
      { q: "9と 12の 最小公倍数を 求めよ。", a: "36" },
      { q: "8と 12の 最大公約数を 求めよ。", a: "4" },
      { q: "15と 20の 最大公約数を 求めよ。", a: "5" },
      { q: "12の 約数を すべて 書け。", a: "1, 2, 3, 4, 6, 12" },
      { q: "7の 倍数を 小さい順に 3つ 書け。", a: "7, 14, 21" },
    ], { section: "倍数と 約数に ついて 答えよ" }) });
  ...
  add({ grade: G, subject: "算数", id: "g5-12", unitNo: 12, name: "算数5年⑫ 分数と 小数", title: "分数と 小数", subtitle: "なおして くらべる", goal: "分数を 小数に、小数を 分数に なおそう！", desc: "分数と小数・整数の関係。",
    body: iplusBody([
      { q: "$\\frac{1}{2}$ を 小数で 表せ。", a: "0.5" },
      { q: "$\\frac{3}{4}$ を 小数で 表せ。", a: "0.75" },
      { q: "$0.7$ を 分数で 表せ。", a: "$\\frac{7}{10}$" },
      { q: "$3\\div4$ の 商を 分数で 表せ。", a: "$\\frac{3}{4}$" },
      { q: "$\\frac{1}{4}$ を 小数で 表せ。", a: "0.25" },
      { q: "$\\frac{1}{5}$ を 小数で 表せ。", a: "0.2" },
      { q: "$0.3$ を 分数で 表せ。", a: "$\\frac{3}{10}$" },
      { q: "$0.25$ を 分数で 表せ。", a: "$\\frac{1}{4}$" },
      { q: "$1\\div8$ の 商を 分数で 表せ。", a: "$\\frac{1}{8}$" },
      { q: "$\\frac{7}{10}$ を 小数で 表せ。", a: "0.7" },
    ], { section: "分数と 小数を なおせ" }) });
  ...
  add({ grade: G, subject: "算数", id: "g5-13", unitNo: 13, name: "算数5年⑬ 割合", title: "割合", subtitle: "割合・百分率", goal: "割合 $=$ くらべる量 $÷$ もとにする量。 百分率も おぼえよう！", desc: "割合の意味と求め方、百分率・歩合。",
    body: iplusBody([
      { q: "20人の うち 5人の 割合を 求めよ。($5\\div20$)", a: "0.25" },
      { q: "$0.25$ を 百分率で 表せ。", a: "25 ％" },
      { q: "200円の 30％は 何円か。($200\\times0.3$)", a: "60 円" },
      { q: "$0.4$ を 歩合で 表せ。", a: "4 わり" },
      { q: "50人の うち 20人の 割合を 求めよ。", a: "0.4" },
      { q: "$0.6$ を 百分率で 表せ。", a: "60 ％" },
      { q: "80％ を 小数で 表せ。", a: "0.8" },
      { q: "500円の 20％は 何円か。", a: "100 円" },
      { q: "30人の 40％は 何人か。", a: "12 人" },
      { q: "定価 800円の 品物を 2割引きで 買うと、代金は 何円か。", a: "640 円" },
      { q: "ある数の 25％が 30 の とき、もとの 数を 求めよ。", a: "120" },
    ], { section: "割合・百分率に ついて 答えよ" }) });
  ...
  add({ grade: G, subject: "算数", id: "g5-14", unitNo: 14, name: "算数5年⑭ 図形の 面積", title: "図形の 面積", subtitle: "三角形・平行四辺形・台形", goal: "三角形・平行四辺形・台形の 面積を もとめよう！", desc: "三角形・平行四辺形・台形・ひし形の面積公式。",
    body: iplusBody([
      { q: "底辺 6cm、高さ 4cm の 三角形の 面積を 求めよ。($6\\times4\\div2$)", a: "12 cm$^2$" },
      { q: "底辺 5cm、高さ 8cm の 平行四辺形の 面積を 求めよ。($5\\times8$)", a: "40 cm$^2$" },
      { q: "上底 3cm、下底 7cm、高さ 4cm の 台形の 面積を 求めよ。($(3+7)\\times4\\div2$)", a: "20 cm$^2$" },
      { q: "底辺 8cm、高さ 5cm の 三角形の 面積を 求めよ。", a: "20 cm$^2$" },
      { q: "底辺 10cm、高さ 6cm の 平行四辺形の 面積を 求めよ。", a: "60 cm$^2$" },
      { q: "上底 4cm、下底 8cm、高さ 5cm の 台形の 面積を 求めよ。", a: "30 cm$^2$" },
      { q: "底辺 12cm、高さ 7cm の 三角形の 面積を 求めよ。", a: "42 cm$^2$" },
      { q: "2本の 対角線が 6cm と 8cm の ひし形の 面積を 求めよ。", a: "24 cm$^2$" },
      { q: "底辺 9cm、高さ 4cm の 平行四辺形の 面積を 求めよ。", a: "36 cm$^2$" },
    ], { section: "図形の 面積を 求めよ" }) });
  ...
  add({ grade: G, subject: "算数", id: "g5-15", unitNo: 15, name: "算数5年⑮ 正多角形と 円", title: "正多角形と 円", subtitle: "円周 $=$ 直径 × 3.14", goal: "円周の もとめ方を おぼえよう！", desc: "正多角形、円周率、円周の求め方。",
    body: iplusBody([
      { q: "直径 10cm の 円の 円周を 求めよ。($10\\times3.14$)", a: "31.4 cm" },
      { q: "直径 8cm の 円の 円周を 求めよ。($8\\times3.14$)", a: "25.12 cm" },
      { q: "半径 5cm の 円の 円周を 求めよ。($10\\times3.14$)", a: "31.4 cm" },
      { q: "正六角形の 辺(角)の 数は いくつか。", a: "6" },
      { q: "直径 6cm の 円の 円周を 求めよ。", a: "18.84 cm" },
      { q: "直径 20cm の 円の 円周を 求めよ。", a: "62.8 cm" },
      { q: "半径 3cm の 円の 円周を 求めよ。", a: "18.84 cm" },
      { q: "半径 10cm の 円の 円周を 求めよ。", a: "62.8 cm" },
      { q: "直径 100cm の 円の 円周を 求めよ。", a: "314 cm" },
      { q: "正八角形の 辺の 数は いくつか。", a: "8" },
    ], { section: "円周を 求めよ(円周率は 3.14)" }) });
  ...
  add({ grade: G, subject: "算数", id: "g5-16", unitNo: 16, name: "算数5年⑯ 体積", title: "体積", subtitle: "直方体・立方体", goal: "直方体・立方体の 体積を もとめよう！", desc: "体積の意味と単位、直方体・立方体の体積公式。",
    body: iplusBody([
      { q: "たて 3cm、よこ 4cm、高さ 5cm の 直方体の 体積を 求めよ。($3\\times4\\times5$)", a: "60 cm$^3$" },
      { q: "1辺 4cm の 立方体の 体積を 求めよ。($4\\times4\\times4$)", a: "64 cm$^3$" },
      { q: "$1$ L は 何 cm$^3$ か。", a: "1000 cm$^3$" },
      { q: "たて 5cm、よこ 6cm、高さ 2cm の 直方体の 体積を 求めよ。", a: "60 cm$^3$" },
      { q: "1辺 3cm の 立方体の 体積を 求めよ。", a: "27 cm$^3$" },
      { q: "たて 10cm、よこ 10cm、高さ 10cm の 直方体の 体積を 求めよ。", a: "1000 cm$^3$" },
      { q: "$1$ m$^3$ は 何 cm$^3$ か。", a: "1000000 cm$^3$" },
      { q: "たて 2cm、よこ 8cm、高さ 5cm の 直方体の 体積を 求めよ。", a: "80 cm$^3$" },
      { q: "1辺 5cm の 立方体の 体積を 求めよ。", a: "125 cm$^3$" },
    ], { section: "体積を 求めよ" }) });
  ...
  add({ grade: G, subject: "算数", id: "g5-17", unitNo: 17, name: "算数5年⑰ 割合と グラフ", title: "割合と グラフ", subtitle: "百分率・円グラフ", goal: "割合を つかって、円グラフや 帯グラフを よもう！", desc: "割合(2)、円グラフ・帯グラフ。",
    body: iplusBody([
      { q: "算数が すきな 人の 割合を 小数で もとめ、百分率でも 表せ。($16\\div40$)", a: "0.4（40 ％）" },
      { q: "国語が すきな 人の 百分率を 求めよ。", a: "25 ％" },
      { q: "理科が すきな 人の 百分率を 求めよ。", a: "20 ％" },
      { q: "社会が すきな 人の 百分率を 求めよ。", a: "15 ％" },
      { q: "算数と 国語を あわせた 百分率を 求めよ。", a: "65 ％" },
      { q: "算数が すきな 人の 割合を 分数で 表せ。", a: "$\\frac{2}{5}$" },
      { q: "いちばん 人数が 少ない 教科は どれか。", a: "社会" },
    ], { section: "割合と グラフに ついて 答えよ", intro: "{\\large 40人の すきな 教科 しらべ\\quad 算数 16人 ／ 国語 10人 ／ 理科 8人 ／ 社会 6人}" }) });
...
function buildG6() {
  ...
  add({ grade: G, subject: "算数", id: "g6-01", unitNo: 1, name: "算数6年① 文字と式", title: "文字と 式", subtitle: "x を つかった 式", goal: "x を つかった 式に 数を あてはめて もとめよう！", desc: "文字x,aを使った式、式の値を求める。",
    body: iplusBody([
      { q: "$x+5$ で $x=8$ の とき、式の 値を 求めよ。", a: "13" },
      { q: "$80\\times x$ で $x=6$ の とき、式の 値を 求めよ。", a: "480" },
      { q: "1本 $x$ 円の えんぴつ 6本と、90円の ノート 1冊の 代金を、$x$ を つかった 式で 表せ。", a: "$x\\times6+90$ (円)" },
      { q: "その 代金が 510円だった。えんぴつ 1本の ねだん $x$ を 求めよ。", a: "70 円" },
      { q: "たて $a$ cm、よこ 8cm の 長方形の 面積を、$a$ を つかった 式で 表せ。", a: "$a\\times8$ (cm$^2$)" },
      { q: "ある数 $x$ を 4倍して 3を たすと 27に なった。$x$ を 求めよ。($x\\times4+3=27$)", a: "6" },
      { q: "$x\\times5-8$ で $x=6$ の とき、式の 値を 求めよ。", a: "22" },
      { q: "$x\\div3$ で $x=12$ の とき、式の 値を 求めよ。", a: "4" },
      { q: "$120\\times x+200$ で $x=4$ の とき、式の 値を 求めよ。", a: "680" },
      { q: "$x\\times4=20$ の とき、$x$ の 値を 求めよ。", a: "5" },
    ], { section: "文字と 式に ついて 答えよ" }) });
  ...
  add({ grade: G, subject: "算数", id: "g6-06", unitNo: 6, name: "算数6年⑥ 対称な 図形", title: "対称な 図形", subtitle: "線対称・点対称", goal: "線対称・点対称の 図形を しらべよう！", desc: "線対称・点対称の定義と性質。",
    body: iplusBody([
      { q: "1本の 直線で おって ぴったり 重なる 図形を 何と いうか。", a: "線対称" },
      { q: "ある点を 中心に 180度 まわすと もとと 重なる 図形を 何と いうか。", a: "点対称" },
      { q: "線対称な 図形で おり目に なる 直線を 何と いうか。", a: "対称の軸" },
      { q: "点対称な 図形で 中心と なる 点を 何と いうか。", a: "対称の中心" },
      { q: "正三角形には 対称の 軸が 何本 あるか。", a: "3 本" },
      { q: "正方形には 対称の 軸が 何本 あるか。", a: "4 本" },
      { q: "正六角形には 対称の 軸が 何本 あるか。", a: "6 本" },
      { q: "平行四辺形は、線対称・点対称の どちらの 図形か。", a: "点対称" },
      { q: "二等辺三角形は 線対称か、点対称か。あてはまる ものを 答えよ。", a: "線対称" },
      { q: "正方形は 線対称でも あり 点対称でも ある。線対称だけの 図形を 1つ あげよ。", a: "例: 二等辺三角形" },
    ], { section: "対称な 図形に ついて 答えよ" }) });
  ...
  add({ grade: G, subject: "算数", id: "g6-07", unitNo: 7, name: "算数6年⑦ 円の 面積", title: "円の 面積", subtitle: "半径 × 半径 × 3.14", goal: "円の 面積の もとめ方を おぼえよう！", desc: "円の面積の求め方、面積公式。",
    body: iplusBody([
      { q: "半径 5cm の 円の 面積を 求めよ。($5\\times5\\times3.14$)", a: "78.5 cm$^2$" },
      { q: "直径 8cm の 円の 面積を 求めよ。($4\\times4\\times3.14$)", a: "50.24 cm$^2$" },
      { q: "半径 6cm の 円の 面積を 求めよ。", a: "113.04 cm$^2$" },
      { q: "半径 10cm の 円を 4等分した、おうぎ形 1つの 面積を 求めよ。", a: "78.5 cm$^2$" },
      { q: "半径 10cm の 半円の 面積を 求めよ。", a: "157 cm$^2$" },
      { q: "直径 20cm の 円の 面積から、半径 5cm の 円の 面積を ひいた 大きさを 求めよ。", a: "235.5 cm$^2$" },
      { q: "円周が 31.4cm の 円が ある。この 円の 半径を 求めよ。", a: "5 cm" },
      { q: "前の 円の 面積を 求めよ。", a: "78.5 cm$^2$" },
      { q: "1辺 10cm の 正方形に ぴったり 入る 円(直径 10cm)の 面積を 求めよ。", a: "78.5 cm$^2$" },
    ], { section: "円の 面積を 求めよ(円周率は 3.14)" }) });
  ...
  add({ grade: G, subject: "算数", id: "g6-08", unitNo: 8, name: "算数6年⑧ 立体の 体積", title: "立体の 体積", subtitle: "角柱・円柱", goal: "角柱・円柱の 体積 $=$ 底面積 × 高さ！", desc: "角柱・円柱の体積の求め方、体積公式。",
    body: iplusBody([
      { q: "底面積 12cm$^2$、高さ 5cm の 角柱の 体積を 求めよ。($12\\times5$)", a: "60 cm$^3$" },
      { q: "たて 4cm、よこ 5cm、高さ 3cm の 直方体の 体積を 求めよ。", a: "60 cm$^3$" },
      { q: "底面が 1辺 4cm の 正方形で、高さ 10cm の 四角柱の 体積を 求めよ。", a: "160 cm$^3$" },
      { q: "底面の 半径 3cm(底面積 28.26cm$^2$)、高さ 10cm の 円柱の 体積を 求めよ。", a: "282.6 cm$^3$" },
      { q: "底面が 底辺 6cm・高さ 4cm の 三角形で、高さ 10cm の 三角柱の 体積を 求めよ。", a: "120 cm$^3$" },
      { q: "底面の 半径 2cm(底面積 12.56cm$^2$)、高さ 5cm の 円柱の 体積を 求めよ。", a: "62.8 cm$^3$" },
      { q: "1辺 6cm の 立方体の 体積を 求めよ。", a: "216 cm$^3$" },
      { q: "体積 200cm$^3$、底面積 25cm$^2$ の 角柱の 高さを 求めよ。", a: "8 cm" },
      { q: "$1$ L は 何 cm$^3$ か。", a: "1000 cm$^3$" },
    ], { section: "体積を 求めよ(底面積 $\\times$ 高さ)" }) });
  ...
  add({ grade: G, subject: "算数", id: "g6-09", unitNo: 9, name: "算数6年⑨ 比とその利用", title: "比と その利用", subtitle: "比を かんたんに", goal: "比を かんたんに したり、比の値を もとめよう！", desc: "比の意味、等しい比、比の値、比の利用。",
    body: iplusBody([
      { q: "$12:18$ を かんたんな 比に せよ。", a: "2:3" },
      { q: "$3:4$ の 比の値を 求めよ。", a: "$\\frac{3}{4}$" },
      { q: "$2:5=8:\\square$ の □に 入る数を 求めよ。", a: "20" },
      { q: "$3:7=\\square:21$ の □に 入る数を 求めよ。", a: "9" },
      { q: "りんごと みかんの 数の 比は $3:2$ で、合わせて 30こ ある。りんごは 何こか。", a: "18 こ" },
      { q: "兄と 弟で 1200円を $5:3$ の 割合で 分ける。兄の 分は 何円か。", a: "750 円" },
      { q: "たてと よこの 長さの 比が $4:5$ の 長方形が ある。たてが 12cm の とき、よこは 何 cm か。", a: "15 cm" },
      { q: "ジュースを 牛乳と $2:3$ で まぜる。牛乳を 90mL つかう とき、ジュースは 何 mL いるか。", a: "60 mL" },
      { q: "$15:25$ を かんたんな 比に せよ。", a: "3:5" },
      { q: "$4:6$ の 比の値を 求めよ。", a: "$\\frac{2}{3}$" },
    ], { section: "比に ついて 答えよ" }) });
  ...
  add({ grade: G, subject: "算数", id: "g6-10", unitNo: 10, name: "算数6年⑩ 拡大図と 縮図", title: "拡大図と 縮図", subtitle: "形は そのまま 大きさを かえる", goal: "拡大図・縮図の かんけいを しらべよう！", desc: "拡大図・縮図の定義と性質、縮尺。",
    body: iplusBody([
      { q: "2cm の 辺を 3倍に 拡大すると 何 cm に なるか。", a: "6 cm" },
      { q: "12cm の 辺を $\\frac{1}{4}$ に 縮小すると 何 cm に なるか。", a: "3 cm" },
      { q: "縮尺 $\\frac{1}{1000}$ の 図で 5cm は、じっさいには 何 m か。", a: "50 m" },
      { q: "縮尺 $\\frac{1}{25000}$ の 地図で 4cm の 道のりは、じっさいには 何 km か。", a: "1 km" },
      { q: "じっさいの 長さ 8m を $\\frac{1}{200}$ の 縮図に かくと 何 cm に なるか。", a: "4 cm" },
      { q: "拡大図や 縮図で、辺の 長さと 角の 大きさの うち、変わらないのは どちらか。", a: "角の 大きさ" },
      { q: "三角形を 2倍の 拡大図に すると、面積は 何倍に なるか。", a: "4 倍" },
      { q: "三角形を 3倍の 拡大図に すると、面積は 何倍に なるか。", a: "9 倍" },
      { q: "高さ 3m の 木の かげが 4m だった。同じ 時こくに かげが 8m の 木の 高さを 求めよ。", a: "6 m" },
    ], { section: "拡大図と 縮図に ついて 答えよ" }) });
  ...
  add({ grade: G, subject: "算数", id: "g6-11", unitNo: 11, name: "算数6年⑪ 比例と 反比例", title: "比例と 反比例", subtitle: "y=きまった数×x", goal: "比例と 反比例の 式を つかえるように なろう！", desc: "比例・反比例の意味と性質、式・グラフ。",
    body: iplusBody([
      { q: "$y$ は $x$ に 比例し、$x=2$ の とき $y=10$ です。きまった数を 求めよ。($y=□\\times x$)", a: "5" },
      { q: "(1)の とき、$x$ と $y$ の 関係を 式で 表せ。", a: "$y=5\\times x$" },
      { q: "(1)の とき、$x=6$ なら $y$ は いくつか。", a: "30" },
      { q: "比例する 2量で、$x$ が 3倍に なると、$y$ は 何倍に なるか。", a: "3 倍" },
      { q: "$y$ は $x$ に 反比例し、$x=3$ の とき $y=8$ です。$x=6$ の とき $y$ は いくつか。", a: "4" },
      { q: "反比例する 2量で、$x$ が 2倍に なると、$y$ は 何倍に なるか。", a: "$\\frac{1}{2}$ 倍" },
      { q: "18L 入る 水そうに 毎分 $x$ L 入れると、$y$ 分で いっぱいに なる。$y$ を $x$ の 式で 表せ。", a: "$y=18\\div x$" },
      { q: "前の 水そうで、毎分 3L 入れると 何分で いっぱいに なるか。", a: "6 分" },
      { q: "反比例の グラフは どんな 形の 線に なるか。", a: "曲線" },
    ], { section: "比例と 反比例に ついて 答えよ" }) });
  ...
  add({ grade: G, subject: "算数", id: "g6-12", unitNo: 12, name: "算数6年⑫ ならべ方と 組み合わせ方", title: "ならべ方と 組み合わせ方", subtitle: "場合の数", goal: "ぜんぶで なんとおり あるか 数えよう！", desc: "並べ方と組み合わせ方、場合の数。",
    body: iplusBody([
      { q: "1, 2, 3, 4 の カードで できる 2けたの 整数は 何とおり あるか。(同じ カードは 1回)", a: "12 とおり" },
      { q: "0, 1, 2 の カードで できる 2けたの 整数は 何とおり あるか。(同じ カードは 1回)", a: "4 とおり" },
      { q: "A, B, C, D の 4人を 1列に ならべる ならべ方は 何とおり あるか。", a: "24 とおり" },
      { q: "4人で リレーの 第1走者と 第2走者を 決める。決め方は 何とおり あるか。", a: "12 とおり" },
      { q: "A, B, C, D の 4人から 2人を えらぶ 組み合わせは 何とおり あるか。", a: "6 とおり" },
      { q: "5人から 2人を えらぶ 組み合わせは 何とおり あるか。", a: "10 とおり" },
      { q: "赤・青・黄・緑 の 4色から 2色を えらぶ 組み合わせは 何とおり あるか。", a: "6 とおり" },
      { q: "コインを 3枚 投げる ときの 表・裏の 出方は 何とおり あるか。", a: "8 とおり" },
    ], { section: "ならべ方と 組み合わせ方を 数えよ" }) });
  ...
  add({ grade: G, subject: "算数", id: "g6-13", unitNo: 13, name: "算数6年⑬ 資料の 整理", title: "資料の 整理", subtitle: "平均値・中央値・最頻値", goal: "データの 代表値(平均値・中央値・最頻値)を もとめよう！", desc: "代表値(平均値・中央値・最頻値)、度数分布。",
    body: iplusBody([
      { q: "平均値を 求めよ。($(2+3+3+4+5+5+5+6+9)\\div9$)", a: "約 4.67 点" },
      { q: "中央値(まんなかの 値)を 求めよ。", a: "5 点" },
      { q: "最頻値(いちばん 多い 値)を 求めよ。", a: "5 点" },
      { q: "はんい(さいだい値 $-$ さいしょう値)を 求めよ。", a: "7 点" },
      { q: "5点 いじょうの 人は 何人 いるか。", a: "5 人" },
      { q: "平均値と 中央値では、どちらが 大きいか。", a: "中央値" },
      { q: "9点の 人が もう 1人 ふえて 10この データに なると、中央値は 何点に なるか。", a: "5 点" },
    ], { section: "データの 代表値を 求めよ", intro: "{\\large つぎの 9この データ\\quad 2, 3, 3, 4, 5, 5, 5, 6, 9 (点)}" }) });
